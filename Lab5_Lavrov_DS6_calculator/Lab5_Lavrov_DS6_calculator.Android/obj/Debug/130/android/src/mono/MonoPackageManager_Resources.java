...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Lab5_Lavrov_DS6_calculator.Android.dll" comes first in this list. */
		"Lab5_Lavrov_DS6_calculator.Android.dll",
		"FormsViewGroup.dll",
		"Lab5_Lavrov_DS6_calculator.dll",
